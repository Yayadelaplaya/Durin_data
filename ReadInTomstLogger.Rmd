...
micro_data <- microclimate %>%
  ...
  group_by(loggerID, daytime, site, land_type,species,plotID) %>%
  summarise(
...
<<<<<<< HEAD
  filter(cutting != "cut" & datetime > "2023-04-28" & datetime < "2023-06-20" & land_type == "DroughtNet" & loggerID != 95221050 & species != "Control") %>%
  mutate(daytime = floor_date(datetime, "day")) %>%
  group_by(loggerID,daytime,species,drt_treatment,fire_class,plotID) %>%
  summarise(
    air_temperature_mean = mean(value[sensor == "air_temperature"]),
    air_temperature_min = min(value[sensor == "air_temperature"]),
    air_temperature_max = max(value[sensor == "air_temperature"]),
...
model_1_air <- lmer(air_temperature_mean ~ site + (1|site/land_type), data = micro_linear)

summary(model_1_air)
#fixed
model_2_air <- lmer(air_temperature_mean ~ land_type + (1|site/land_type), data = micro_linear)

summary(model_2_air)

model_3_air <- lmer(air_temperature_mean ~ site*land_type + (1|loggerID), data = micro_linear)

summary(model_3_air)

model_4_air <- lmer(air_temperature_mean ~ daytime + (1|loggerID), data = micro_linear)

summary(model_4_air)


anova(model_1_air, model_2_air, model_3_air)
#random
model_5_air <- lmer(air_temperature_mean ~ site + (1|site/land_type/individual) + (1|species), data = micro_linear)
summary(model_5_air)
anova(model_1_air, model_5_air)

###ground_temperature
# Example of fixed effects comparisons, with same random effects structure
model_1_ground <- lmer(ground_temperature_mean ~ site + (1|site/land_type), data = micro_linear)

summary(model_1_ground)
#fixed
model_2_ground <- lmer(ground_temperature_mean ~ site + land_type + (1|site/land_type/individual), data = micro_linear)

summary(model_2_ground)

model_3_ground <- lmer(ground_temperature_mean ~ site*land_type + (1|site/land_type/individual), data = micro_linear)

summary(model_3_ground)

model_4_ground <- lmer(ground_temperature_mean ~ site*land_type*species + (1|site/land_type/individual), data = micro_linear)

summary(model_4_ground)
anova(model_1_ground, model_2_ground, model_3_ground, model_4_ground)
#random
model_5_ground <- lmer(ground_temperature_mean ~ site + (1|site/land_type/individual) + (1|species), data = micro_linear)
summary(model_5_ground)
anova(model_1_ground, model_5_ground)

###soil_temperature
# Example of fixed effects comparisons, with same random effects structure
model_1_soil <- lmer(soil_temperature_mean ~ site + (1|site/land_type), data = micro_linear)

summary(model_1_soil)
#fixed
model_2_soil <- lmer(soil_temperature_mean ~ site + land_type + (1|site/land_type/individual), data = micro_linear)

summary(model_2_soil)

model_3_soil <- lmer(soil_temperature_mean ~ site*land_type + (1|site/land_type/individual), data = micro_linear)

summary(model_3_soil)

model_4_soil <- lmer(soil_temperature_mean ~ site*land_type*species + (1|site/land_type/individual), data = micro_linear)

summary(model_4_soil)
anova(model_1_soil, model_2_soil, model_3_soil, model_4_soil)
#random
model_5_soil <- lmer(soil_temperature_mean ~ site + (1|site/land_type/individual) + (1|species), data = micro_linear)
summary(model_5_soil)
anova(model_1_soil, model_5_soil)

###soil moisture
# Example of fixed effects comparisons, with same random effects structure
model_1_moist <- lmer(soil_moisture_mean ~ site + (1|site/land_type), data = micro_linear)

summary(model_1_moist)
#fixed
model_2_moist <- lmer(soil_moisture_mean ~ site + land_type + (1|site/land_type/individual), data = micro_linear)

summary(model_2_moist)

model_3_moist <- lmer(soil_moisture_mean ~ site*land_type + (1|site/land_type/individual), data = micro_linear)

summary(model_3_moist)

model_4_moist <- lmer(soil_moisture_mean ~ site*land_type*species + (1|site/land_type/individual), data = micro_linear)

summary(model_4_moist)
anova(model_1_moist, model_2_moist, model_3_moist, model_4_moist)
#random
model_5_moist <- lmer(soil_moisture_mean ~ site + (1|site/land_type/individual) + (1|species), data = micro_linear)
summary(model_5_moist)
anova(model_1_moist, model_5_moist)
...
##### day or night
dn_model_10_air <- lmer(air_temperature_mean ~ dayornight + (1|plotID), data = micro_linear3)
summary(dn_model_10_air)

dn_model_10_ground <- lmer(ground_temperature_mean ~ dayornight + (1|plotID), data = micro_linear3)
summary(dn_model_10_ground)

dn_model_10_soil <- lmer(soil_temperature_mean ~ dayornight + (1|plotID), data = micro_linear3)
summary(dn_model_10_soil)

dn_model_10_moist <- lmer(soil_moisture_mean ~ dayornight + (1|plotID), data = micro_linear3)
summary(dn_model_10_moist)

dn_model_11_air <- lmer(air_temperature_mean ~ dayornight*drt_treatment + (1|plotID), data = micro_linear3)
summary(dn_model_11_air)

dn_model_11_ground <- lmer(ground_temperature_mean ~ dayornight*drt_treatment + (1|plotID), data = micro_linear3)
summary(dn_model_11_ground)

dn_model_11_soil <- lmer(soil_temperature_mean ~ dayornight*drt_treatment + (1|plotID), data = micro_linear3)
summary(dn_model_11_soil)

dn_model_11_moist <- lmer(soil_moisture_mean ~ dayornight*drt_treatment + (1|plotID), data = micro_linear3)
summary(dn_model_11_moist)
